          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              {[
                ...
                <div
                  key={index}
                  className="p-8 bg-gradient-to-br from-stone-50 to-green-50 rounded-2xl border-2 border-green-200 text-center"
                >
            ...
            <div className="bg-gradient-to-br from-stone-50 to-green-50 rounded-2xl p-8 border-2 border-green-200">
              <h2 className="text-3xl font-bold text-green-900 mb-6 text-center">
                Gửi Tin Nhắn
              </h2>
              <form className="space-y-6">
                <div>
                  <label className="block text-green-900 font-semibold mb-2">Họ Tên</label>
                  <input
                    type="text"
                    className="w-full px-4 py-3 rounded-lg border-2 border-green-200 focus:border-green-700 focus:outline-none"
                ...
                <div>
                  <label className="block text-green-900 font-semibold mb-2">Tin Nhắn</label>
                  <textarea
                    rows={5}
                    className="w-full px-4 py-3 rounded-lg border-2 border-green-200 focus:border-green-700 focus:outline-none"
